...
class YachtCheckoutWidget extends StatefulWidget {
  final String title;
  final String owner;
  ...
  @override
  _YachtCheckoutWidgetState createState() => _YachtCheckoutWidgetState();
}

class _YachtCheckoutWidgetState extends State<YachtCheckoutWidget> {
                  ...
                  child: Column(
                    children: [
                      Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          Text('${'hour'.tr} ${widget.hours}h'),
                          Text('\$${widget.hours * widget.hourPrice}')
                        ],
                      ),
                    const  SizedBox(
                        height: 10,
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Text(
                              '\$${(widget.hours * widget.hourPrice) * widget.gratuity / 100}')
                        ],
                      ),
                   const   SizedBox(
                        height: 10,
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Text(
                              '\$${(widget.hours * widget.hourPrice) * widget.brokrFee / 100}')
                        ],
                      ),
                   const   SizedBox(
                        height: 10,
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Text(
                              '\$${(widget.hours * widget.hourPrice) * widget.tax / 100}'),
                        ],
                      ),
                   const   SizedBox(
                        height: 10,
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Text(
                              '\$${(widget.hours * widget.hourPrice) + ((widget.hours * widget.hourPrice) * widget.gratuity / 100) + ((widget.hours * widget.hourPrice) * widget.brokrFee / 100) + ((widget.hours * widget.hourPrice) * widget.tax / 100)}',
                              style: const TextStyle(fontWeight: FontWeight.bold))
                        ],
                      )
                    ],
