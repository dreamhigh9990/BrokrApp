...
class PhotosCarSection extends StateFullCustom {
  final ListingCarBloc bloc;
  PhotosCarSection({super.key, required this.bloc});

  @override
  State<PhotosCarSection> createState() => _PhotosCarSectionState();
}

class _PhotosCarSectionState extends State<PhotosCarSection> {
